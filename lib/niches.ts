...
export const FORMAT_NICHES: Record<string, Niche[]> = {
  ...
  shortform: [
    { id: "faceless", name: "AI-Generated Faceless Shorts", queries: ["ai story shorts", "ai generated shorts", "ai animation shorts", "ai history facts shorts", "ai reddit story shorts", "ai narration shorts"], rpm: { min: 0.5, max: 3, avg: 1.5 }, competition: "medium", difficulty: "easy" },
